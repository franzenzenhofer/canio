...
(function() {
  var Canio, byArray, byImage, clamp, copy, dlog, fff, flip, getToolbox, ifw, invert, mF, make, mirror, mosaic, nb, newToolbox, resize, rotateLeft, rotateRight, toArray, toImage, _DEBUG_,
    __slice = [].slice;
