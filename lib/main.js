...
(function() {
  var Canio, byArray, byImage, clamp, copy, crop, dlog, fff, flip, getToolbox, ifw, invert, mF, make, mirror, mosaic, nb, newToolbox, resize, rotateLeft, rotateRight, scale, toArray, toImage, _DEBUG_,
    __slice = [].slice;
