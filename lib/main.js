...
(function() {
  ...
  Canio.applyIfRgba = function(c, canio_filter, canio_filter_arguments, if_filter, cb) {
    var orig_c, orig_ctx, orig_imgd, orig_pxs, _ref;
    orig_c = Canio.copy(c);
    _ref = Canio.getToolbox(orig_c), orig_c = _ref[0], orig_ctx = _ref[1], orig_imgd = _ref[2], orig_pxs = _ref[3];
    return Canio.many(c, [canio_filter], [canio_filter_arguments], function(c) {
      var ctx, filter, imgd, new_c, new_ctx, new_imgd, new_pxs, pxs, _ref1, _ref2;
      _ref1 = Canio.getToolbox(c), c = _ref1[0], ctx = _ref1[1], imgd = _ref1[2], pxs = _ref1[3];
      _ref2 = Canio.newToolbox(c), new_c = _ref2[0], new_ctx = _ref2[1], new_imgd = _ref2[2], new_pxs = _ref2[3];
      filter = function(r, g, b, a, i) {
      ...
      return Canio.rgba(orig_c, cb, filter);
    });
  };
