...
(function() {
  var Canio, byArray, byImage, clamp, copy, crop, dlog, fff, flip, getToolbox, ifw, isFunction, mF, make, mirror, nb, newToolbox, resize, rgba, rotateLeft, rotateRight, scale, screen, toArray, toImage, _DEBUG_,
    __slice = [].slice;
  ...
  Canio.rgba = rgba = function() {
    ...
    while (y < h) {
      ...
      while (x < w) {
        ...
        a = i + 3;
        if (!extended) {
          _ref3 = filter(pxs[r], pxs[g], pxs[b], pxs[a]), u8[r] = _ref3[0], u8[g] = _ref3[1], u8[b] = _ref3[2], u8[a] = _ref3[3];
        } else {
          _ref4 = filter(pxs[r], pxs[g], pxs[b], pxs[a], c, i), u8[r] = _ref4[0], u8[g] = _ref4[1], u8[b] = _ref4[2], u8[a] = _ref4[3];
        }
        x = x + 1;
      }
      y = y + 1;
  ...
  Canio.oil = mF(ImageFilters.Oil, 2, 32);
